...
namespace Morhollow
{
    public class Game
    {
        ...
        {
            Console.WriteLine("Hail and well met! Thou art welcomed to Morhollow's Quest.");
            Console.WriteLine("Might thou reveal thy name unto us?");
            _playerName = Console.ReadLine();

            if (_playerName == "Stefan")
            {
                Console.WriteLine($"Here comes {_playerName}!!");
            }
            else if (_playerName == "")
            {
                Console.WriteLine("Player name not entered, giving the name Klaus");
                _playerName = "Klaus";
            }
            else
            {
                Console.WriteLine($"Joyous greetings! {_playerName}, we are going to have fun together, at least I will. I prithee declare, as the sentinel of Morhollow, I do stand. A pleasure it is to meet you.");
            }
        }
